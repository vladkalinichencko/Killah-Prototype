...
struct ContentViewInline: View {
    ...
    var body: some View {
        ...
        .padding()
        .onAppear {
            print("ContentViewInline appeared. Starting LLM Engine.")
            llmEngine.startEngine()
        }
        .onDisappear {
            print("ContentViewInline disappeared. Stopping LLM Engine.")
